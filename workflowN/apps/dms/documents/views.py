...
class ApplicationDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['data'] = Application.objects.get(pk=self.kwargs.get('pk')).data
        json_data = json.loads(context['data'])
        # context["client_code"] = json_data["client_code"] #line is removed to prevent key error
        context["client_code"] = licensed.CLIENT_NAME
        return context
