{
    let init = function () {
        ...
        let $assigned_user_select = $('#assigned_user_list');
         ...
         var post_dept_api="", get_dept_api="", freestaff_api = "";
        if(indicator == 'dept') {
            post_dept_api = location.origin + '/api/v1/dms/departments/department/';
            get_dept_api = location.origin + '/api/v1/dms/departments/getdepartment/';
            freestaff_api = location.origin + '/api/v1/dms/departments/freestaff/';
        }
        else{
            post_dept_api = location.origin + '/api/v1/dms/departments/branch/';
            get_dept_api = location.origin + '/api/v1/dms/departments/getbranch/';
            freestaff_api = location.origin + '/api/v1/dms/departments/freestaffbranch/';
        }
